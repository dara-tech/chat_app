    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="sm:flex sm:items-start">
        ...
        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
          <DialogTitle
            as="h3"
            className="text-base font-semibold leading-6 text-mute-foreground"
          >
      ...
      <div className="gap-2 mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
        <Button className="bg-red-800" disabled={isLoading} onClick={onDelete}>
          Delete
        </Button>
        <Button className="bg-blue-800" disabled={isLoading} onClick={onClose}>
          Cancel
        </Button>
      </div>
    </Modal>
